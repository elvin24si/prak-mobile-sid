package com.example.elvinPrak.Home.pertemuan_10
...
import com.example.elvinPrak.databinding.FragmentTabCBinding

class TabCFragment : Fragment() {

    // _binding is backing property, only valid between onCreateView and onDestroyView
